...
?>
<body>
<h3>Data Album Dinas PPKBP3A Kota Pagar Alam [ <?php $jumlah=mysql_num_rows($tampil); echo"$jumlah";?> ]</h3>
<p><table width="100%" border="0">
  <tr>
    <td><a href="?page=input_galeri">Tambah Foto</a></td>
  </tr>
</table></p>
...
echo "Jumlah galeri yang tersimpan sebanyak = $jumlah1";
echo "<br>";
echo " =>";
echo "Aksi ";
echo "|";
echo "<a href='?page=data_album&edit=$id_alb'>Edit</a>";
echo "||";
echo "<a href='?page=data_album&hapus=$id_alb'onClick='return tanya()'>Delete</a>";
echo "|";
echo "<hr>";
}
...
<?php } else {?>
<h3 align="left">Tambah Album</h3>
<FORM ACTION="?page=data_album" METHOD="POST" NAME="input">
<table align="left" cellpadding="0" cellspacing="0" border="0" width="50%">
<tr>
<td width="106"><strong>Nama Album </strong></td>
<td width="11">:</td>
<td width="288"><input type="text" name="nama_alb" size="10" class="form-control" ></td>
</tr>
<tr>
<td>&nbsp;</td>
</tr>
<tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td>&nbsp;&nbsp;<input type="submit" name="Input" value="Simpan" class="btn btn-success">
  <a href="?page=data_album" style="text-decoration:none;"><input type="button" name="clear2" value="Batal" class="btn btn-danger"/></a>
  </td>
</tr>
<?php }?>
</table><br />
